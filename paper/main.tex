...
\begin{figure}[tp]
  \begin{mdframed}
    ...
    \end{center}
    \caption{HOGG: A visualization of part of the binary mask. HOGG: Comment on the left edge (no windows).\label{fig:binarymask}}
  \end{mdframed}
\end{figure}
...
\begin{figure}[tp]
  \begin{mdframed}
    ...
    \end{center}
    \caption{HOGG: A visualization of part of the empirical template. HOGG: Comment on the left edge (no windows).\label{fig:empirical}}
  \end{mdframed}
\end{figure}
