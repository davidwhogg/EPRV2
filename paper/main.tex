...
% - Make the comment that the detailed noise model doesn't matter -- the CCF RVs are as good as the ML RVs.
...
HOGG: Refer to \figref{fig:calibration}
...
HOGG: Refer to \figref{fig:telluric}.
...
HOGG: Refer to \figref{fig:variable}.
